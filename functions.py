...
def plot_barChart(scores, speakerFlag, names, img):
    ...
    if speakerFlag:
        ...
        plt.axhline(y=max(height)-1,linewidth=4,color= 'coral')
    else:
        left = [1,2,3,4]
    ...
    plt.bar(left, height, tick_label = names, width = 0.8, color = [ (0.7725490196078432, 0.6901960784313725, 0.8352941176470589)]) #, color = ['blue', 'cadetblue', 'cornflowerblue']
    plt.axhline(y=max(height), linewidth=4, color= 'purple')
...
def spectral_Rolloff(file_name, img):
...
# [ (0.7725490196078432, 0.6901960784313725, 0.8352941176470589),'thistle']
# tableau20 = [
...
# ]
# tableau1 = [(0.12156862745098039, 0.4666666666666667, 0.7058823529411765),
